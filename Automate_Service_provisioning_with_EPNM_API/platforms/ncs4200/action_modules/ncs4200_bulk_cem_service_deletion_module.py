...
def ncs4200_del_main(epnm_ip, epnm_username, epnm_password, filename, cem_type, services, enable_webex_notifier=False,access_token='', toPersonEmail=''):
    """
    ...
    * 1. Extract Data
    ...
    df, total_service_to_create = ncs4200_get_data_from_excel(filename, cem_type)
