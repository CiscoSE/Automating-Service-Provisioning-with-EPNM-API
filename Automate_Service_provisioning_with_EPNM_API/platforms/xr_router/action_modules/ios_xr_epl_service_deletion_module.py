...
from platforms.xr_router.utils.cisco_ios_xr_epl_service_deletion_template import *
from utils.check_service_status_and_report import *


def ios_xr_service_del_main(epnm_ip, epnm_username, epnm_password, filename, service_type, services, enable_webex_notifier=False,access_token='', toPersonEmail=''):
    """
    ...
    * Login in epnm session with appropriate url
    """
    url = BASE_EPNM_URL.format(epnm_ip) + RESTCONF_OPERATION_RESOURSE + DELETION_RESOURCE
    ...
    for i in total_service_to_create_list:
        ...
        * 2. Create payload
        """
        payload = epl_service_deletion_payload(df, i)
